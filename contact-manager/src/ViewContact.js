...
const ViewContact = () => {
    ...
    const downloadPDF = () => {
        ...
        const columnWidths = [20, 45, 30, 40, 55, 15]; // Define column widths
    
        // Add title
        doc.setFontSize(20);
        doc.text('Kongu Engineering College', 60, y);
        y += 10; // Space after title
    
        // Add subtitle
        doc.setFontSize(16);
        doc.text(`Contacts for ${selectedDesignation}`, 55, y);
        ...
        currentContacts.forEach(contact => {
            ...
            if (selectedCategory === 'teaching' || selectedDesignation === 'Lab Assistant' || selectedDesignation === 'Office Assistant') {
                rowData.push(contact.department);
            }
